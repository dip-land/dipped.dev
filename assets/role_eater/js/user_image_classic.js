window.addEventListener('load', async () => {
    ...
    const gameData = await (await fetch(`/api/${guildID}/${userID}/activity/game?limit=5`)).json();
    const musicData = await (await fetch(`/api/${guildID}/${userID}/activity/music?limit=5`)).json();
