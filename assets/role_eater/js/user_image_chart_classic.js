window.addEventListener('load', async () => {
    ...
    const data = await (await fetch(`/api/${guildID}/${userID}`)).json();
    const positions = await (await fetch(`/api/${guildID}/positions`)).json();
    const activityData = await (await fetch(`/api/${guildID}/${userID}/activity`)).json();
    const latestActivityData = await (await fetch(`/api/${guildID}/${userID}/activity/latest`)).json();
    const gameData = await (await fetch(`/api/${guildID}/${userID}/activity/game`)).json();
    const musicData = await (await fetch(`/api/${guildID}/${userID}/activity/music`)).json();
