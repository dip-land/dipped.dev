...
!(function (e, n) {
        ...
        e.exports = (function () {
            ...
            return (
                (r.xyslider = function (e) {
                    var n = i(e.class || '', e.parent),
                        t = i('pointer', n);
                    return i('shape shape1', t), i('shape shape2', t), i('bg bg1', n), i('bg bg2', n), r(n, a(e.cbs, t)), { background: n, pointer: t };
                }),
                (r.slider = function (e) {
                    var n = i(e.class, e.parent),
                        t = i('pointer', n);
                    return i('shape', t), i('bg', n), r(n, a(e.cbs, t)), { background: n, pointer: t };
                }),
                r
            );
            function a(e, t) {
            ...
            function g(e, n, t) {
                ...
                var r,
                    ...
                    u = n.clientWidth,
                    s = n.clientHeight,
                    l = { x: ((i = t), (i.touches ? i.touches[i.touches.length - 1] : i).clientX), y: ((a = t), (a.touches ? a.touches[a.touches.length - 1] : a).clientY) },
                    f = (l.x - o.x) / u,
                    c = (l.y - o.y) / s;
                    ...
                    (c.installColorSpace = function (a, i, e) {
                        ...
                        for (var t in (['valueOf', 'hex', 'hexa', 'css', 'cssa'].forEach(function (e) {
                            ...
                            (r.equals = function (e, n) {
                                ...
                                for (var t = 0; t < i.length; t += 1) if (Math.abs(this['_' + i[t]] - e['_' + i[t]]) > n) return !1;
                                return !0;
                            }),
                            (r.toJSON = function () {
                                return [a].concat(
                    ...
                    a.installColorSpace('XYZ', ['x', 'y', 'z', 'alpha'], {
                        ...
                        rgb: function () {
                            var e = this._x,
                                ...
                                t = this._z,
                                r = function (e) {
                                    return 0.0031308 < e ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : 12.92 * e;
                                };
                            return new a.RGB(
                        ...
                        lab: function () {
                            var e = function (e) {
                                return 0.008856 < e ? Math.pow(e, 1 / 3) : 7.787037 * e + 4 / 29;
                            },
                                n = e(this._x / 95.047),
                                t = e(this._y / 100),
                                r = e(this._z / 108.883);
                        ...
                        u.installColorSpace('CMYK', ['cyan', 'magenta', 'yellow', 'black', 'alpha'], {
                            ...
                            fromRgb: function () {
                                var e = this._red,
                                    ...
                                    o = 1;
                                return (
                                    e || n || t ? ((o = Math.min(r, Math.min(a, i))), (r = (r - o) / (1 - o)), (a = (a - o) / (1 - o)), (i = (i - o) / (1 - o))) : (o = 1),
                ...
                (n = [r.init, r.xy, r.z]).map(e).filter(s).length != n.length
                    ...
                    : function (e, n, t) {
                        return (function (e) {
                            ...
                            var r = e.cbs,
                                a = p.xyslider({ parent: n, class: 'twod', cbs: { begin: i, change: i, end: h } });
                            function i(e) {
                            ...
                            var d = {
                                ...
                                on: function (e, n, t) {
                                    return (
                                        'change' == e || 'done' == e ? f[e].push({ name: t, fn: n }) : console.warn('Passed invalid evt name "' + e + '" to colorjoe.on'), this
                                    );
                                },
    ...
    function m(e) {
        ...
        var n = o(e);
        return n || (i(e) && console.warn('Passed invalid color to colorjoe, using black instead'), o('#000'));
    }
    function _(e) {
